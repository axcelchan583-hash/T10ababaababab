...
capture log close
log using "`logs'/run_idc_scope_event_study_binned_stata_20260525.log", text replace
...
postfile `handle' ///
    ...
    double mean_y ///
    using "`tables'/idc_scope_event_study_binned_20260525.dta", replace
...
use "`tables'/idc_scope_event_study_binned_20260525.dta", clear
...
export delimited using "`tables'/idc_scope_event_study_binned_20260525.csv", replace

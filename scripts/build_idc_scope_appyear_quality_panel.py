#!/usr/bin/env python3
"""Merge application-year quality patent panels with formal IDC scope X."""
...
def main() -> None:
    ...
    out_csv = PROCESSED / f"idc_scope_appyear_quality_panel_{START_YEAR}_{END_YEAR}.csv"
    out_dta = PROCESSED / f"idc_scope_appyear_quality_panel_{START_YEAR}_{END_YEAR}.dta"

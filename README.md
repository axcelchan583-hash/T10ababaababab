...
> 城市 IDC 服务覆盖是否扩大城市创新进入边界？

当前主 Y 固定为 `new_applicant_share`。HHI、Top share、中腰部挤压和企业技术领域结果都只作为结构性补充或异质性，不再作为最硬主线。
...
2026-05-25 之后进一步收窄为“城市 IDC 服务覆盖是否扩大城市创新进入边界”，不再把“创新集中”作为主因果结论。

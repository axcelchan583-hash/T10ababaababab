...
截至 2026-05-29，Top 榜单流动性死亡审计完成：`scope>=2` 事件研究和新晋 Top 主体类型有一定支持，但授权/被引/家族被引授权质量口径不支持，且被引授权口径显著为负。因此 T10 不再建议作为主力论文推进；除非补到真实算力容量或更微观识别，否则应暂停或归档。
...
- [Top 榜单流动性死亡审计](docs/memos/top_turnover_death_audit_20260529.md)
...
- `scope>=2` 事件研究中，Top10/Top20 榜单产出流动性在事件后 +1 到 +3 年为正，前趋势联合检验不显著；
- 新晋 Top10 的产出份额主要来自非个人组织，个人项不显著；
- 但企业单项、高校科研单项不稳；
- 质量口径失败：普通授权和家族被引授权不显著，被引授权 Top 流动性显著为负。
...
Top 榜单流动性也不足以支撑主力论文。
T10 应暂停或归档；
除非补到真实算力容量或更微观识别，否则不再继续换 Y。
```

详见：

- `docs/memos/top_turnover_death_audit_20260529.md`
- `chat/outline/12_top_turnover_death_audit_review_20260529.md`
